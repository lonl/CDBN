function [model, errors] = rbmGB(X, numhid, varargin)
%Learn RBM with Bernoulli hidden and Gaussian visible units
%based on implementation of Kevin Swersky and Ruslan Salakhutdinov

%INPUTS: 
%X              ... data. should be continuous
...
for epoch = 1:maxepoch
    ...
    for batch = 1:numbatches
		...
		negdatastates = negdata + randn(numcases,numdims);
